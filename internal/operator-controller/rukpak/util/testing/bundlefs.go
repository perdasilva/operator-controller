...
// WithBundleAnnotations is an option for NewBundleFS used to set the content of the
// bundle filesystems metadata/annotations.yaml file
func WithBundleAnnotations(annotations registry.Annotations) BundleFSOption {
