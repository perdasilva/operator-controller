...
| Progressing | `.status.conditions[?(@.type=='Progressing')].status` | Is something actively happening? |
...
`Installed Bundle` (the bundle name) is dropped because it's rarely needed at a glance — the CE name itself identifies the extension, and the version is more actionable. The `Installed` condition column is replaced by `Ready`, which is a more useful signal. The `Rollout` and `Target` columns provide upgrade visibility without requiring `kubectl describe`.
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   True    False         1.0.0                        5d
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   True          <none>    Install   1.0.0    30s
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   True          <none>                       2m
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   True    True          1.0.0                        5d
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   False         <none>    Install   1.0.0    2m
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   True          <none>    Install   1.0.0    5m
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   True          <none>                        1m
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   False         <none>    Install   1.0.0    5m
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   False   False         <none>    Install   1.0.0    35m
```
...
$ kubectl get clusterextensions
NAME          READY   PROGRESSING   VERSION   ROLLOUT   TARGET   AGE
my-operator   True    True          1.0.0                        30d
```
